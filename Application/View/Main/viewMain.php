<div class="row">
    <div class="large-12 columns">
        <div class="slider single-item">
            <img src="http://placehold.it/1920x1080&text=[ img 1 ]"/>
            <img src="http://placehold.it/1920x1080&text=[ img 2 ]"/>
            <img src="http://placehold.it/1920x1080&text=[ img 3 ]"/>
            <img src="http://placehold.it/1920x1080&text=[ img 4 ]"/>
        </div>
    </div>
</div>
    ...
    <div class="large-12 columns">
        ...
        <div class="row">
            <div class="large-6 columns">
                <p>© no Copyright at all. Go to town.</p>
            </div>
            <div class="large-6 columns">
